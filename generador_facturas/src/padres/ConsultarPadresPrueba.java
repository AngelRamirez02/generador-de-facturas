 ...
 * @author ar275
 */
public class ConsultarPadresPrueba extends javax.swing.JFrame {
...
//        PanelRound paneliqz = new PanelRound();
//        paneliqz.setLayout(null);
//        paneliqz.setSize(150, fondo.getHeight()-barra_nav.getHeight()+10);
//        paneliqz.setLocation(0, barra_nav.getHeight());
//        paneliqz.setRoundBottomRight(50);
//        paneliqz.setRoundTopRight(50);
//        paneliqz.setBackground(colorbtnNoSeleccionado);
//        fondo.add(paneliqz);
    ...
    private void initComponents() {
        ...
        contenedor.add(txt_emisoresRegistrados, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 910, 50));
        ...
        contenedor.add(btn_descarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 50, 60, 60));
        ...
        contenedor.add(rfc_busqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 110, 710, 50));
        ...
        contenedor.add(titulo_rfc, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 250, 230, 40));
        ...
        contenedor.add(rfc_show, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 290, 230, 40));
        ...
        contenedor.add(titulo_estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 360, 270, 40));
        ...
        contenedor.add(titulo_apellidoPaterno, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 250, 40));
        ...
        contenedor.add(estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 400, 270, 40));
        ...
        contenedor.add(titulo_apellidoMaterno, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, 230, 40));
        ...
        contenedor.add(apellido_materno, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 290, 230, 40));
        ...
        contenedor.add(titulo_nombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 250, 280, 40));
        ...
        contenedor.add(nombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 290, 280, 40));
        ...
        contenedor.add(titulo_regimen, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 460, 330, 40));
        ...
        contenedor.add(titulo_correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 360, 330, 40));
        ...
        contenedor.add(titulo_cp, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 360, 180, 40));
        ...
        contenedor.add(titulo_fechaNacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, 210, 40));
        ...
        contenedor.add(titulo_municipio, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 460, 220, 40));

        lb_campos.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        lb_campos.setText("Datos del padre consultado:");
        contenedor.add(lb_campos, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 350, 40));
        ...
        contenedor.add(apellido_paterno, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 250, 40));
        ...
        contenedor.add(correo_electronico, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 400, 330, 40));
        ...
        contenedor.add(codigo_postal, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 400, 180, 40));
        ...
        contenedor.add(fecha_nacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 400, 210, 40));
        ...
        contenedor.add(municipio, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 500, 220, 40));
        ...
        contenedor.add(regimen, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 500, 330, 40));
        ...
        contenedor.add(no_interior, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 500, 130, 40));
        ...
        contenedor.add(titulo_colonia, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 460, 190, 40));
        ...
        contenedor.add(titulo_noExterior, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 460, 130, 40));
        ...
        contenedor.add(titulo_noInterior, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 460, 130, 40));
        ...
        contenedor.add(colonia, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 500, 190, 40));
        ...
        contenedor.add(no_exterior, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 500, 130, 40));
        ...
        contenedor.add(lb_noEncontrados, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 360, 1050, 60));

        lb_inicial.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        lb_inicial.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lb_inicial.setText("INGRESE EL RFC DEL PADRE A CONSULTAR");
        contenedor.add(lb_inicial, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 1050, 60));
    ...
    void cargarDatosPdf() {
        try {
            ...
            Logger.getLogger(ConsultarPadresPrueba.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void ocultarCampos() {
        lb_noEncontrados.setVisible(true);
        //
    ...
    private void rfc_busquedaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rfc_busquedaActionPerformed
        if(rfc_busqueda.getSelectedItem().equals("Buscar")){
            ocultarCampos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarPadresPrueba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarPadresPrueba().setVisible(true);
            }
        });
    }
