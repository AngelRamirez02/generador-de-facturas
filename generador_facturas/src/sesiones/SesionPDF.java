...
public class SesionPDF{
    ...
    public void generarPdf(List<SesionPDF> listaSesiones, String ruta) throws FileNotFoundException, DocumentException, BadElementException, IOException{
        //Fecha
        ...
        try {
            ...
            Logger.getLogger(SesionPDF.class.getName()).log(Level.SEVERE, null, ex);
        }
...
// Método para dibujar una línea de separación
    ...
    public SesionPDF(String id_sesion, String usuario, String fecha_entrada, String horario_entrada, String fecha_salida, String horario_salida) {
